...
type
  ...
  CollisionConfiguration* {.
    header: bullet, importcpp: "btCollisionConfiguration".} = object of RootObj
  ...
  SphereShape* {.
    header: bullet, importcpp: "btSphereShape".} = object of CollisionShape
  ...
  RigidBodyConstructionInfo* {.
    header: bullet, importcpp: "btRigidBody::btRigidBodyConstructionInfo"
  .} = object

  SequentialImpulseConstraintSolver* {.
    header: bullet, importcpp: "btSequentialImpulseConstraintSolver".} = object
...
func makeCollisionDispatcher*(
  ...
  header: bullet, importcpp: "btCollisionDispatcher(@)", constructor.}
...
func makeDbvtBroadphase*(): DbvtBroadphase {.
  header: bullet, importcpp: "btDbvtBroadphase()", constructor.}

func makeDefaultCollisionConfiguration*(): DefaultCollisionConfiguration {.
  header: bullet, importcpp: "btDefaultCollisionConfiguration()", constructor.}
...
func makeDiscreteDynamicsWorld*(
  ...
  header: bullet, importcpp: "btDiscreteDynamicsWorld(@)", constructor.}
...
func collisionObjectArray*(
  ...
  header: bullet, importcpp: "#.getCollisionObjectArray()".}

func numCollisionObjects*(world: DiscreteDynamicsWorld): int {.
  header: bullet, importcpp: "#.getNumCollisionObjects()".}

proc removeCollisionObject*(
  world: var DiscreteDynamicsWorld, obj: ptr CollisionObject
) {.header: bullet, importcpp: "#.removeCollisionObject(#)".}
...
proc rigidBodyUpcast*(obj: ptr CollisionObject): ptr RigidBody {.
  header: bullet, importcpp: "btRigidBody::upcast(@)".}

proc motionState*(body: ptr RigidBody): ptr MotionState {.
  header: bullet, importcpp: "#.getMotionState()".}
...
func makeTransform*(): Transform {.
  header: bullet, importcpp: "btTransform()", constructor.}

proc origin*(transform: Transform): var Vector3 {.
  header: bullet, importcpp: "#.getOrigin()".}

proc `origin=`*(transform: var Transform, origin: Vector3) {.
  header: bullet, importcpp: "#.setOrigin(#)".}

proc setIdentity*(transform: Transform) {.
  header: bullet, importcpp: "#.setIdentity()".}

func makeVector3*(x: float32, y: float32, z: float32): Vector3 {.
  header: bullet, importcpp: "btVector3(@)", constructor.}
